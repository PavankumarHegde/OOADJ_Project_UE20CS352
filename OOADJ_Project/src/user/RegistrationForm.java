...
public class RegistrationForm extends JPanel implements ActionListener {
	...
	public RegistrationForm() {
		...
		submit.setFont(new Font("Sakkal Majalla", Font.BOLD, 18));
		...
		reset.setFont(new Font("Sakkal Majalla", Font.BOLD, 18));
		...
		year.setModel(new DefaultComboBoxModel<String>(new String[] {"2000", "2001", "2002", "2003", "2004", "2005", "2006"}));
	...
	public RegistrationForm(EditDetails e) {
		...
		lblRegDate.setForeground(Color.BLACK);
